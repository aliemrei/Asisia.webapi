...
{ // Comment
    public partial class VIRTUAL_POS_DEP_PAYMENTS_CANCEL : EntityBase // My Handlebars Helper
    {
        public VIRTUAL_POS_DEP_PAYMENTS_CANCEL()
        {
        ...
        public virtual VIRTUAL_POS_DEP_PAYMENTS PAYMENT { get; set; } = null!;
